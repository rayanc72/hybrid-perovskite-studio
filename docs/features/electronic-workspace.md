...
The Electronic workspace focuses on plotting and inspecting electronic-structure outputs. It collects the app's polarization, DOS, bandstructure, spin-texture, and absorption workflows under one workspace.
